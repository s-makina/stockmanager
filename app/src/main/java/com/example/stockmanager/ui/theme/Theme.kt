...
//    val harmonizedError =
//        harmonize(error, colorScheme.primary)
//    val roles = getColorRoles(harmonizedError, isLight)
...
//            customColor.roles = getColorRoles(blendedColor, isLight)
//        } else {
//            customColor.roles = getColorRoles(customColor.color, isLight)
//        }
//    }
